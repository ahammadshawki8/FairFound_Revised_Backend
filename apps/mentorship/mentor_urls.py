...
from .views import MentorListView, MentorDetailView, MentorReviewListView, ConnectMentorView, DisconnectMentorView, MentorAvailabilityView, MyReviewsView, MentorPublicAvailabilityView
...
urlpatterns = [
    ...
    path('<int:pk>/availability/', MentorPublicAvailabilityView.as_view(), name='mentor_public_availability'),
